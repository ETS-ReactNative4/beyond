...
declare namespace ns_config {
    ...
    const config: {
        readonly "__#84774@#hierarchy": string[];
        readonly hierarchy: string[];
        readonly "__#84774@#widgets": Map<number, IWidgetRendered>;
...
declare namespace ns_widgets_layoutchildren {
    ...
    const instances: {
        "__#84789@#BeyondLayoutChildrenRenderer": IBeyondLayoutChildrenRenderer;
        "__#84789@#instances": Set<BeyondLayoutChildren>;
...
declare namespace ns_widgets_widgets {
    ...
    const widgets: {
        "__#84791@#WidgetControllerLoader": IWidgetControllerLoader;
        "__#84791@#instances": Set<Widget>;
        "__#84791@#initialised": boolean;
        "__#84791@#roots": Map<Node, Widget>;
